...
import { updatedProduct,getProductsDetails, clearErrors} from '../actions/productActions';
...
const UpdateProduct = () => {
    ...
    }, [dispatch, alert, error, isUpdated,Navigation, updateError, product, productId])
